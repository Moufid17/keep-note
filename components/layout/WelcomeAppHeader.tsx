    ...
    return (
        <header className="relative top-0 z-50 w-full">
            <div className='fixed w-full flex'>
                <nav className="absolute left-0 z-52 container px-3 py-3 w-[92%] md:w-full lg:full h-20 flex justify-between items-center gap-2 border rounded-t-2xl bg-background shadow-md transition-all duration-300 ease-in-out hover:shadow-lg">
                ...
                {/* Mobile Menu */}
                <div id="mobile-menu" ref={mobileMenuRef} className="absolute z-52 top-20 hidden md:hidden w-full"
                    onClick={handleClickInsideMenuDiv}
                >
                    <div className="container px-4 py-3 flex flex-col space-y-3 w-[90%] border-t bg-background shadow-md rounded-b-2xl">
...
export default WelcomeAppHeader