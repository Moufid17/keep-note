            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition">
                        ...
                        <h3 className="text-xl text-black font-semibold mb-2">Smart Search</h3>
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition">
                        ...
                        <h3 className="text-xl text-black font-semibold mb-2">Cross-Device Sync</h3>
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition">
                        ...
                        <h3 className="text-xl text-black font-semibold mb-2">Speech to Text</h3>
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition">
                        ...
                        <h3 className="text-xl text-black font-semibold mb-2">Organize Effortlessly</h3>
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition">
                        ...
                        <h3 className="text-xl text-black font-semibold mb-2">End-to-End Encryption</h3>
